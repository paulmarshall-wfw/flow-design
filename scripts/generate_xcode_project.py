...
\t\tA0010000000000000000000D /* FlowDesignFileDocument.swift in Sources */ = {isa = PBXBuildFile; fileRef = A00100000000000000000029 /* FlowDesignFileDocument.swift */; };
...
\t\tA00100000000000000000029 /* FlowDesignFileDocument.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = FlowDesignFileDocument.swift; sourceTree = "<group>"; };
...
\t\t\tsourceTree = "<group>";
\t\t};
\t\tA00100000000000000000092 /* FlowDesignApp */ = {isa = PBXGroup; children = (A00100000000000000000021 /* FlowDesignApp.swift */, A00100000000000000000029 /* FlowDesignFileDocument.swift */, ); path = FlowDesignApp; sourceTree = "<group>"; };
...
\t\tA001000000000000000000A0 /* Sources */ = {isa = PBXSourcesBuildPhase; buildActionMask = 2147483647; files = (A00100000000000000000001 /* FlowDesignApp.swift in Sources */, A0010000000000000000000D /* FlowDesignFileDocument.swift in Sources */, ); runOnlyForDeploymentPostprocessing = 0; };
